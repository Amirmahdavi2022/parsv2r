...
object Utils {
     ...
     */
    // Do not restore the applicationId check that used to live here. It asked "am I the Xray
    // build?" by looking at the package name, so renaming the app answered no and quietly put
    // it on the v2fly code path. This fork ships the Xray core, so it says so.
